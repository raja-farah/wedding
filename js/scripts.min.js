function initMap() {
    var e = { lat: -7.29731, lng: 112.77365 },
    ...
    $("#add-to-cal").html(r),
        $("#rsvp-form").on("submit", function (e) {
            ...
            $("#alert-wrapper").html(
                ...
                "cf08ec7aced6814b1c579fc859392791" !== MD5($("#invite_code").val()) &&
                    "cf08ec7aced6814b1c579fc859392791" !== MD5($("#invite_code").val())
                    ? $("#alert-wrapper").html(
                        alert_markup(
                            "danger",
                    ...
                    : $.post(
                        "https://script.google.com/macros/s/AKfycbwIR7EmfSkCYkpKZZVfqwbYRUfK7cV2RLbO0Ft9vq4Uua6gKGF6X0yodcsbEsUU--PvVA/exec",
                        t
                    )
                        .done(function (e) {
                            console.log(e),
